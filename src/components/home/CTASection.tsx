...
export default function CTASection() {
     ...
     const [badgeRef, badgeVisible] = useScrollAnimation({ delay: 100 })
     const [headingRef, headingVisible] = useScrollAnimation({ delay: 200 })
     const [descriptionRef, descriptionVisible] = useScrollAnimation({ delay: 300 })
     const [valuePropsRef, valuePropsVisible] = useScrollAnimation({ delay: 400 })
     const [buttonsRef, buttonsVisible] = useScrollAnimation({ delay: 500 })
     const [trustRef, trustVisible] = useScrollAnimation({ delay: 600 })
